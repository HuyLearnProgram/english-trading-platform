...
import { CreateBlogDto, UpdateBlogDto, QueryBlogsDto } from './dto';
...
export class BlogController {
  ...
  @Get()
  listBlogs(@Query() q: QueryBlogsDto) {
    return this.svc.findBlogs(q);             
  }

  @Post()
  createBlog(@Body() dto: CreateBlogDto) {
    return this.svc.createBlog(dto);
  }
